package gg.scala.melon.commons.constants;
...
public class QueueGlobalConstants {
    ...
    public static final String JEDIS_KEY_PLAYER_CACHE = "queue:players";
    public static final String JEDIS_KEY_QUEUE_CACHE = "queue:queued";
    public static final String JEDIS_KEY_SETTING_CACHE = "queue:settings";
    public static final String JEDIS_KEY_SERVER_DATA_CACHE = "queue:data";
