...
import gg.scala.melon.provider.impl.DefaultSettingsProvider;
import gg.scala.melon.provider.impl.ScandiumSettingsProvider;
...
@Getter
public final class QueueBukkit extends ExtendedScalaPlugin implements QueuePlatform {
    ...
    private Banana bungeeJedisManager;
